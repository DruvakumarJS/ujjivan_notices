...
<div class="container-body">
	 ...
	 <hr/>
       ...
       <form method="POST" action="{{ route('update_custom_notice')}}" enctype="multipart/form-data">
        @csrf 	
      ...
      <div class="row" id="state_dropdown_list">
       ...
       <input type="hidden" name="notice_group" value="{{$noticegroup}}">
      ...
      <input type="hidden" name="length" id="length" value="{{count($custData)}}">

      
      @foreach($custom_noticeData as $keyl=>$value)
      <hr/>
       <div class="row">
            ...
            <div id="collapse-example" class="collapse show" aria-labelledby="heading-example">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="input-group mb-3">
                             <input class="form-control" type="text" name="notice[{{$keyl}}][tittle]" maxlength="250" value="{{$value->name}}" required>
                            </div>
                        </div>   
                   </div>
                   ...
                   <div class="row">
                        ...
                        <div class="col-6">
                            <div class="input-group mb-3">
                             <input class="form-control" type="text" name="notice[{{$keyl}}][description]" maxlength="250" value="{{$value->description}}" required>
                            </div>
                        </div>   
                   </div>


                   <input class="form-control" type="hidden" name="notice[{{$keyl}}][langauge]" value="{{$value->lang_code}}">
                            ...
                            <td>
                                  <div class="row d-flex justify-content-center align-items-center">
                                     <div class="col-md-5">
                                      ...
                                      <select class="form-control form-select" name="contact[{{$i}}][name]">
                                        <option>Select lable</option>
                                        @foreach($info_columns as $key=>$info)
                                           <option {{ ($key == $keys)?'selected':'' }} value="{{$key}}">{{$info}}</option>
                                        @endforeach
                                      </select>
                                     </div>

                                     <div class="col-md-5">
                                      <select class="form-control form-select" name="contact[{{$i}}][value]">
                                        <option>Select Contact</option>
                                        @foreach($info_columns as $key=>$info)
                                           <option {{ ($key == $values)? 'selected' : '' }} value="{{$key}}">{{$info}}</option>
                                        @endforeach
                                      </select> 
                                     </div>
                                     <div class="col-md-1">
