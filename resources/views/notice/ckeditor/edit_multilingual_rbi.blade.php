                   ...
                   <div id="collapse-example" class="collapse show" aria-labelledby="heading-example">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-3">
                                 <input class="form-control" type="text" name="notice[{{$keyl}}][tittle]" value="{{$value->name}}" required>
                                </div>
                            </div>   
                       </div>
                       ...
                       <div class="row">
                            ...
                            <div class="col-6">
                                <div class="input-group mb-3">
                                 <input class="form-control" type="text" name="notice[{{$keyl}}][description]" value="{{$value->description}}" required>
                                </div>
                            </div>   
                       </div>
