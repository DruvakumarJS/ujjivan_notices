      ...
      <div class="row" id="state_dropdown_list">
       ...
       <div class="row" id="state_div">
        ...
        <div class="row" id="state_div">
            ...
            <div class="col-6" id="state_dropdown">
                <div class="input-group mb-3">
                 <input class="form-control" type="text" name="document_id" value="{{$data->document_id}}" readonly>
                </div>
            </div>   
       </div>
       ...
       <div class="row" id="state_div">
            ...
            <div class="col-6" id="state_dropdown">
                <div class="input-group mb-3">
                 <input class="form-control" type="text" name="version" value="{{$data->version}}"  readonly>
                </div>
            </div>   
       </div>
       ...
       <div class="row" id="state_div">
            ...
            <div class="col-6" id="state_dropdown">
                <div class="input-group mb-3">
                 <input class="form-control" type="text" name="publish_date" id="publish_date" value="{{$data->published_date}}" autocomplete="off" disabled>
                </div>
            </div>   
       </div>
